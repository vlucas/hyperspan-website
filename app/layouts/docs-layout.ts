...
function DocsNavMenu(activePath: string) {
  ...
  <ul class="menu bg-base-200 rounded-box w-full">
    ...
    <li>
      <h2 class="menu-title">Routing</h2>
      <ul>
        <li class="${renderActiveClass('routes')}"><a href="/docs/routes" class="link">Routing Basics</a></li>
        <li class="${renderActiveClass('routes/api')}"><a href="/docs/routes/api" class="link">API Endpoints</a></li>
    ...
    <li>
      ...
      <ul>
        ...
        <li class="${renderActiveClass('actions')}"><a href="/docs/actions" class="link">Server Actions</a></li>
