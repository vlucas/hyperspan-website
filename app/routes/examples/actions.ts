  ...
  const content = html`
    <main class="prose pl-6">
      ...
      <p>
        ...
        in place. Hyperspan Actions <strong>require very little JavaScript to work</strong>, and can be used in any template or route. Read more about Actions in the <a href="/docs/actions">Actions Docs</a>.
      </p>
      ...
      <p>You can create an action by using the <code>createAction</code> function from the <code>@hyperspan/framework/actions</code> package, similar to how you would create a route.</p>
